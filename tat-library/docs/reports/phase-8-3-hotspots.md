...
Generated: 2026-05-05T22:34:32.807Z
...
- Source files scanned: 464
- Approximate non-empty LOC: 27,358
- Ranked hotspots found: 25
- Files with legacy-pattern hits: 30
...
------------------------------------ | -------- | ------
tests/all-directives-expanded.tat    | 29.00ms  | ok    
tests/semantic-directives-demo.tat   | 177.00ms | ok    
tests/phase7/import-compose-main.tat | 109.00ms | ok    
```
...
--------------------- | -------- | -----
resolveImports        | 100.00ms | 4    
executeProgram        | 79.00ms  | 4    
execute.graphPipeline | 70.00ms  | 12   
parseRoot             | 16.00ms  | 4    
tokenize              | 13.00ms  | 4    
readSource            | 1.00ms   | 4    
```
...
---- | ----- | ------------------------------------------------------ | ---- | --- | ------- | ----- | -----
1    | 100   | runtime/execute/action.ts                              | 1178 | 44  | 27      | 168   | 5    
2    | 84    | runtime/query/executeWhere.ts                          | 1277 | 53  | 4       | 216   | 5    
3    | 82    | runtime/validation/expressions/expressionValidators.ts | 1032 | 36  | 2       | 85    | 4    
...
### 1. runtime/execute/action.ts

Score: **100**

Signals:

- oversized file (1178 LOC)
- high function count (44)
- high import coupling (27)
- large switch/case dispatch (168 cases)
- high conditional density (106 ifs)
...
### 2. runtime/query/executeWhere.ts

Score: **84**

Signals:

- oversized file (1277 LOC)
- high function count (53)
- large switch/case dispatch (216 cases)
- high conditional density (118 ifs)
...
### 3. runtime/validation/expressions/expressionValidators.ts
