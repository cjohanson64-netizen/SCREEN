import type { Graph, GraphEdge, GraphHistoryEntry, GraphNode, GraphValue } from "../graph/graph.js";
import { cloneGraphValue, getNode } from "../graph/graph.js";
...
export function buildApplyRaw(
  ...
  return `@action.apply(<${from}.${action}.${to}>)`;
}
