...
import type { Graph, GraphEdge, GraphValue } from "../graph/graph.js";
...
import { executeWhy, type ReasonResultSet } from "../execute/query/why.js";
import { getAction, type ActionRegistry } from "../engine/actionRegistry.js";
...
function executeGraphQueryExpr(
  graph: Graph,
