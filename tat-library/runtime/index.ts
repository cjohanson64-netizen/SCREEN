...
import { validateProgram, type ValidationIssue } from "./validation/validateProgram.js";
import { executeTatModule as executeTatModuleInternal, type ExecuteTatModuleOptions } from "./engine/executeModule.js";
import {
...
} from "./query/relationshipComparison.js";
import {
...
): ReturnType<typeof executeTatModuleInternal> {
  return executeTatModuleInternal(entryPath, options);
}
...
export type { RuntimeTimingEntry, RuntimeTimingReport } from "./instrumentation/timing.js";
export type { CachedParsedSource, RuntimeParseCacheStats } from "./cache/parseCache.js";
export type {
  CachedInjectionFragment,
  InjectionContextKind,
  RuntimeInjectionFragmentCacheStats,
} from "./cache/injectionFragmentCache.js";
export { createRuntimeTimingCollector } from "./instrumentation/timing.js";
export { RuntimeParseCache, getDefaultRuntimeParseCache } from "./cache/parseCache.js";
export {
  RuntimeInjectionFragmentCache,
  getDefaultRuntimeInjectionFragmentCache,
} from "./cache/injectionFragmentCache.js";
export {
  ParseError,
  tokenize,
...
export {
  ...
  listDirectivesByFamily,
} from "./directives/registry.js";
export type {
  DirectiveDefinition,
  DirectiveFamily,
  DirectiveRuntimeSurface,
