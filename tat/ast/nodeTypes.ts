...
export interface ReduceExprNode extends BaseNode {
  type: "ReduceExpr";
  name: "@reduce";
  syntax: "inline" | "block";
  args: ArgumentNode[];
...
export type TerminalGraphExprNode = ProjectExprNode | ReduceExprNode;
...
export interface IfValueExprNode extends BaseNode {
  type: "IfValueExpr";
  name: "@if";
...
export type DeriveAggregateSourceNode =
  | DerivePathExprNode
...
export interface DeriveMinExprNode extends BaseNode {
  type: "DeriveMinExpr";
  name: "@derive.min";
  from: DeriveAggregateSourceNode | null;
  field: StringLiteralNode | null;
...
export interface DeriveMaxExprNode extends BaseNode {
  type: "DeriveMaxExpr";
  name: "@derive.max";
  from: DeriveAggregateSourceNode | null;
  field: StringLiteralNode | null;
...
export interface DeriveAvgExprNode extends BaseNode {
  type: "DeriveAvgExpr";
  name: "@derive.avg";
  from: DeriveAggregateSourceNode | null;
  field: StringLiteralNode | null;
...
export interface DeriveAbsExprNode extends BaseNode {
  type: "DeriveAbsExpr";
  name: "@derive.abs";
